...
with col_b:
    ...
    fig_mdd_hist = go.Figure(go.Histogram(x=mdds, nbinsx=30, marker_color='#EF4444', name="MDD %"))
    fig_mdd_hist.update_layout(
        title="MDD Distribution (Histogram)",
    ...
    st.plotly_chart(fig_mdd_hist, use_container_width=True)
